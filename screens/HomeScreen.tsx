...
export default function HomeScreen() {
  ...
  // Calcula categorias de despesa apenas do mês selecionado
  ...
  // Manipula a mudança de mês com animação de loading
  const handleMonthChange = useCallback(
    (month: number, year: number) => {
      setMonthChanging(true);
      // Anima a mudança de mês
      setTimeout(() => {
  ...
  // Manipula o salvamento do novo saldo
